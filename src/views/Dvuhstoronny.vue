...
<div>
    <div class="another-block1">
        <div class="text-right3">ДВУХСТОРОННИЙ ПОЛИМЕРНЫЙ ПРОФЛИСТ</div>
        <div class="text-right4">Лист покрыт цветным полимером с обеих сторон.</div>
    </div>
...
<style scoped>
    ...
    #box-1 .box-left {
        background: linear-gradient(to right, rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.3)), url(~@/assets/images/dvuh1.jpg);
    }
    #box-2 .box-left {
        background: linear-gradient(to right, rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.3)), url(~@/assets/images/dvuh2.jpg);
    }
    #box-3 .box-left {
        background: linear-gradient(to right, rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.3)), url(~@/assets/images/dvuh3.jpg);
    }
    .caption {
        width: 100%;
        height: 75%;
    ...
    .another-block1 {
        height: 180px;
        background-color: black;
        background: linear-gradient(to right, rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.3)), url(~@/assets/images/dvuhtop.jpg);
