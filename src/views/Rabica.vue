<template>
    <div>
        <div class="another-block1">
            ...
            <pre class="text-right4">Забор из сетки-рабица является самым популярным типом ограждения,
благодаря своему удобству и практичности.</pre>
        </div>
...
(столб: 40х40 / 50х50, ячейка: 50х50мм)</pre>
                ...
                <div class="box-right">
                    ...
                    <div class="text-right1">м/п от 490 руб.</div>
                </div>
            </div>
...
<style scoped>
    ...
    #box-1 .box-left {
        background: linear-gradient(to right, rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.3)), url(~@/assets/images/rabica1.jpg);
    }
    #box-2 .box-left {
        background: linear-gradient(to right, rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.3)), url(~@/assets/images/rabica2.jpg);
    }
    #box-3 .box-left {
        background: linear-gradient(to right, rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.3)), url(~@/assets/images/rabica3.jpg);
    }
    .caption {
        width: 100%;
        height: 75%;
    ...
    .another-block1 {
        height: 180px;
        background-color: black;
        background: linear-gradient(to right, rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.3)), url(~@/assets/images/rabicatop.jpg);
