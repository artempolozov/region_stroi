<template>
    <div>
        <div class="another-block1">
            ...
            <div class="text-right4">Современный тип заборов с дополнительным изгибом
                для увеличения прочности и надежности.</div>
        </div>
...
(столб: 40х40 / 50х50, ячейка: 50х200мм)</pre>
                    </div>
                </div>
                <div class="box-right">
...
<style scoped>
    ...
    #box-1 .box-left {
        background: linear-gradient(to right, rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.3)), url(~@/assets/images/setka1.jpg);
    }
    #box-2 .box-left {
        background: linear-gradient(to right, rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.3)), url(~@/assets/images/setka2.jpg);
    }
    .caption {
        width: 100%;
        height: 75%;
    ...
    .another-block1 {
        height: 180px;
        background-color: black;
        background: linear-gradient(to right, rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.3)), url(~@/assets/images/setkatop.jpg);
