...
<div>
    <div class="another-block1">
        ...
        <div class="text-right4">Данный вид ограждения выполняется при помощи металлического штакетника,</div>
        <div class="text-right4">расположенного в шахматном порядке.</div>
    </div>
...
(столб: 40х40 / 50х50 / 60х60, лаги: 40х20мм)</pre>
            ...
            <div class="box-right">
                <div class="text-right2">Цена: </div>
                <div class="text-right">м/п от 2690 руб.</div>
            </div>
        </div>
...
(столб: 40х40 / 50х50 / 60х60, лаги: 40х20мм)</pre>
            ...
            <div class="box-right">
                <div class="text-right2">Цена: </div>
                <div class="text-right">м/п от 2790 руб.</div>
            </div>
        </div>
    </div>
</div>
